...
public final class AsyncUnaryServerHandler<
...
>: GRPCServerHandlerProtocol {
  ...
  @usableFromInline
  internal let userFunction: (Request, AsyncServerCallContext) async throws -> Response
  ...
  public init(
    ...
    userFunction: @escaping (Request, AsyncServerCallContext) async throws -> Response
  ) {
  ...
  internal func receiveInterceptedMessage(_ request: Request) {
    ...
    case let .createdContext(context):
      ...
      context.responsePromise.completeWithAsync {
        try await self.userFunction(request, context)
      }
