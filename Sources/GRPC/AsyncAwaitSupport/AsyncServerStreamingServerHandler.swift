...
public final class AsyncServerStreamingServerHandler<
...
>: GRPCServerHandlerProtocol {
  ...
  @usableFromInline
  internal let userFunction: (Request, AsyncResponseStreamWriter<Response>, AsyncServerCallContext) async throws -> Void
  ...
  public init(
    ...
    userFunction: @escaping (Request, AsyncResponseStreamWriter<Response>, AsyncServerCallContext) async throws -> Void
  ) {
  ...
  internal func receiveInterceptedMessage(_ request: Request) {
    ...
    case let .createdContext(context):
      ...
      context.statusPromise.completeWithAsync {
        try await self.userFunction(request, responseStreamWriter, context)
        return .ok
      }
...
extension AsyncServerStreamingServerHandler {
